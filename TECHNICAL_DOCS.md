...
### ۳.۴. پشتیبانی دوطرفه و تثبیت جهت ادیتور زیرنویس (i18n & LTR Subtitle Editor)
- سیستم سوئیچ آنی زبان رابط کاربری به همراه فرهنگ لغات کامل در رابط تک‌صفحه‌ای وب.
- تثبیت جهت LTR (`direction: ltr !important`) برای فیلد پیش‌نمایش زیرنویس‌ها به منظور جلوگیری از به‌هم‌ریختگی شماره خطوط، تایم‌استمپ‌ها و زمان‌بندی‌ها در حالت راست‌چین.
